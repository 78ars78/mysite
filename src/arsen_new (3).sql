...
--
-- Хост: mysql
-- Время создания: Июл 26 2024 г., 13:50
...
INSERT INTO `moto` (`id`, `marka`, `name`, `model`, `color`, `brightness`, `img`, `img_0`) VALUES
(3, 'ferrari', 'fer1', '1', 'red', 'bright', 'ferrari_red', ''),
(2, 'ferrari', 'fer2', '2', 'yellow', 'bright', 'ferrari_yellow', ''),
(1, 'ferrari', 'fer3', '3', 'black', 'dark', 'ferrari_black', ''),
(4, 'ferrari', 'fer4', '4', 'gray', 'bright', 'ferrari_gray', ''),
(5, 'bentley', 'ben3', '1', 'red', 'bright', 'bentley_red', ''),
(6, 'bentley', 'ben2', '2', 'black', 'dark', 'bentley_black', ''),
(7, 'bentley', 'ben1', '3', 'gray', 'bright', 'bentley_gray', ''),
(8, 'bentley', 'ben4', '4', 'yellow', 'bright', 'bentley_yellow', ''),
(9, 'lambo', 'lam3', '1', 'red', 'bright', 'lambo_red', ''),
(10, 'lambo', 'lam2', '2', 'yellow', 'bright', 'lambo_yellow', ''),
(11, 'lambo', 'lam1', '3', 'gray', 'bright', 'lambo_gray', ''),
(12, 'lambo', 'lam4', '4', 'black', 'dark', 'lambo_black', '');
