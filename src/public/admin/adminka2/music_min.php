...
<td valign="top" width="205" bgcolor="white"><? include_once "lefttd.php"; ?>
</td><td  valign="top">
<? 
// пагинация
/* include "paging.php";  */?>
...
?>
<?
if ($id6==0) {  echo "<br><br>&nbsp;Корень сайта"; exit;
 } ?>
<br><br> <div style="position: relative; position:absolute; width:800px;  right: 100px; "><? include "paging.php"; ?></div>


<!-- <button type="button" onclick="loadDoc()" style="color:green; position:fixed; top:200px; left: 500px; inline-size:25ch; aspect-ratio:1; border-color: green; border-radius:50%; width: 400; cursor:pointer;">с изм</button> -->
<p align=left><a href="new_cat.php?parent=0" style=" width:148px; background:gray; position:absolute; top:26px; left:210px; color:yellow; text-decoration:none" >&nbsp;Добавить категории&nbsp;</a></p>
...
<button type="button" onclick="loadDoc()"  style="color:green; position:fixed; top:25px; left: 580px;  border-color: green;   width: 400; cursor:pointer;">СОХРАНИТЬ ИЗМЕНЕНИЯ !!!</button>
...
// пагинация  
include "paging.php";
?></div><!-- <div style=" position: relative; position:absolute; left: 700px; width: 550px; "><? include "paging.php"; ?></div> -->
