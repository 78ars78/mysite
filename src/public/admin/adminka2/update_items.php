...
<center>
<button id="history-button" style="border-color:green; position:relative; top:100px; inline-size:25ch; aspect-ratio:1; border-radius:50%;  width: 400; height:400; cursor:pointer;">обновлено!</button></center>
