...
<form action='<?= htmlspecialchars($_SERVER["PHP_SELF"]) ?>' method='post'>
    ...
    <table class="table table-hover table-responsive table-bordered">
        ...
        <tr>
            <td>Название</td>
            <td><input type="text" name="name" class="form-control" value="hi !!!"/></td>
        </tr>
  
        <tr>
            <td>Цена</td>
            <td><input type="text" name="price" class="form-control" value="999" /></td>
        </tr>
  
        <tr>
            <td>Описание</td>
            <td><textarea name="description" class="form-control">sdfgb</textarea></td>
        </tr>
