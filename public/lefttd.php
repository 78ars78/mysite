...
$k=1;
    ...
    printf( "<p align=left>&nbsp&nbsp&nbsp&nbsp<a style='color:#424242; text-decoration: none;' href='auto_min.php?hh=2&i=1&j=$k'>%s</a></p>",$row1["razr"]);
		...
		$m=1;
			...
			extract($row2);	 
	if($m==$n) { printf( "<p align=left>&nbsp&nbsp<a style='margin-left:20px; background-color:grey; color:white; text-decoration: none;' href='auto_min.php?hh=3&i=1&j=$k&l=$m'>%s</a></p>",$row2["razr"]); } else {
	printf( "<p align=left>&nbsp&nbsp<a style='margin-left:20px; color:green; text-decoration: none;' href='auto_min.php?hh=3&i=1&j=$k&l=$m'>%s</a></p>",$row2["razr"]); 	}
